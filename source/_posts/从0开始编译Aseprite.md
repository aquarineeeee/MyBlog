...
categories:
  - 技术随笔
description: |
  起因是想做出8-bit风格的贝尔抖动和做一些用于开发的sprite动画
...
**刚好**前段时间上图形学与多媒体技术的时候**碰巧**了解到了贝尔抖动（这不就是我最喜欢的半色调吗！）最近正好在做这个网站，想要像素感的界面，就想起了aseprite,本来准备买下但是突然看到有源代码，那还说啥了自己编译吧！前一天晚上想到做这个，今天起来两眼一睁就是干，现在看来那节课也算是埋下了伏笔。
## 编译大冒险
